                ...
                <div class="row">
                    ...
                    <div class="col-xl  col-sm">
						<div class="card bg-warning invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"><?php echo $tong_tien_nap_user['SUM(`total_money`)'] ?></h2>
									<span class="text-white fs-18">Tổng Tiền Đã Nạp</span>
								</div>
							</div>
						</div>
					</div>
                    ...
                    <div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"><?php echo $tong_tien_bill_user['SUM(`price`)'] ?></h2>
									<span class="text-white fs-18">Tổng Tiền Đã Mua</span>
								</div>
							</div>
						</div>
					</div>
                    <div class="col-xl  col-sm">
						<div class="card bg-warning invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"><?php echo $tong_bill_user['COUNT(`id_bill`)'] ?></h2>
